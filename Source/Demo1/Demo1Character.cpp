...
void ADemo1Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ADemo1Character::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ADemo1Character::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void ADemo1Character::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool ADemo1Character::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	...
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ADemo1Character::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &ADemo1Character::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &ADemo1Character::TouchUpdate);
		return true;
	}
